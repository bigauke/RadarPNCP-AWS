...
files = ["generate_relatorio_pdf.py", "generate_pdf.py", "generate_infra_pdf.py", "README.md", "infra.md", "Relatorio_RadarPNCP_Etapa3.md"]
...
for filename in files:
    ...
    for o, n in reps.items():
        # Careful with 'orgao' because of JSON keys. Let's do a special pass for 'orgao' that avoids '"orgao"'
        content = re.sub(o, n, content)
        
    content = re.sub(rR'\borgao\b(?!")', 'órgão', content)
